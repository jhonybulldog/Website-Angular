...
export class Proggetti {
  Progetti = [
    ...
    {
      immagine: "/e-commerce.png",
      titolo: "e-commerce esempio",
    ...
    },
    {
      ...
      descrizione:
        "Collezione completa dei miei proggetti open-source e personali, include strumenti webm script di automazione e proggetti di apprendimento",
      tech: ["git"],
    ...
    },
    {
      immagine: "/blog.png",
      titolo: "Blog",
      descrizione:"esempio di blog scritto in angular",
      tech: ["HTML5", "CSS3", "TypeScript", "Angular"],
      link: "/blog",
      testoLink: "Blog",
    },
